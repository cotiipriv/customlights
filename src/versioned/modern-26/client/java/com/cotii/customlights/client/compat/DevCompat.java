...
public final class DevCompat {
    ...
    public static void createFlatLevel(Minecraft minecraft, String name) {
        // Game rules are no longer part of the settings: a short test stays at night and peaceful keeps it empty
        LevelSettings settings = new LevelSettings(name, GameType.CREATIVE, new LevelSettings.DifficultySettings(Difficulty.PEACEFUL, false, false),
