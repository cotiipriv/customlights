package com.cotii.customlights.forge.fabric.client.command.v2;
    ...
    static FabricClientCommandSource local() {
        return new FabricClientCommandSource() {
            ...
            public void sendError(Component message) {
                Minecraft.getInstance().gui.getChat().addMessage(Component.empty().append(message).withStyle(ChatFormatting.RED));
            }
